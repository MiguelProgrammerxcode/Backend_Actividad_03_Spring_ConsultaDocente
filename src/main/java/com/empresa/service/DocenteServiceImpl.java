...
public class DocenteServiceImpl implements DocenteService {
	...
	@Override
	public List<Docente> listaDocentePorDniNombreUbigeo(String dni, String nombre, int idUbigeo, int estado) {
		return repository.listaDocentePorDniNombreUbigeo(dni, nombre, idUbigeo, estado);
	}
